...
func TestExtractNumber(t *testing.T) {
	...
	data := []numTest{
		...
		{0, 1, 0, 8, 4, []byte{4}},
		{0, 2, 0, 16, 4, []byte{4, 0}},
		{0, 3, 0, 24, 4, []byte{4, 0, 0}},
		{0, 4, 0, 32, 4, []byte{4, 0, 0, 0}},
		{0, 5, 0, 40, 4, []byte{4, 0, 0, 0, 0}},
		{0, 6, 0, 48, 4, []byte{4, 0, 0, 0, 0, 0}},
		{0, 7, 0, 56, 4, []byte{4, 0, 0, 0, 0, 0, 0}},
		{0, 8, 0, 64, 4, []byte{4, 0, 0, 0, 0, 0, 0, 0}},

		// Aligned to byte boundaries, fractional byte sizes
		{0, 1, 0, 3, 1, []byte{0x79}},
		{0, 2, 0, 11, 321, []byte{0x41, 0x79}},
		{0, 3, 0, 22, 1655134, []byte{0x5e, 0x41, 0xD9}},
		{0, 4, 0, 29, 155278871, []byte{0x17, 0x5e, 0x41, 0xC9}},
		{0, 5, 0, 37, 39751391043, []byte{0x43, 0x17, 0x5e, 0x41, 0xC9}},

		// Real world values, a NAME
		{0, 3, 0, 21, 110737, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{2, 4, 5, 11, 273, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{4, 5, 0, 3, 0, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{4, 5, 3, 5, 0, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{5, 6, 0, 8, 130, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{6, 7, 0, 1, 0, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{6, 7, 1, 7, 25, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{7, 8, 0, 4, 0, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{7, 8, 4, 3, 4, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
		{7, 8, 7, 1, 1, []byte{0x91, 0xb0, 0x21, 0x22, 0x00, 0x82, 0x32, 0xc0}},
	}
